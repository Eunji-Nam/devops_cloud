...
def artist_length_above_3(song_dict):
    artist: str = song_dict["artist"]
    return len(artist) >= 3


for song_dict in filter(artist_length_above_3, song_list):
    print("{artist} {len(artist)}".format(**song_dict))
